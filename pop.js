...
(function(exports){
	...
	var popCSS = ['<style type="text/css" data-module="UI-pop-prompt-plane">',
		'@font-face {',
			'font-family:"UI";',
			'src:url("/api/FrontEnd/Javascripts/UI/images/ui-webfont.eot");',
			'src:url("/api/FrontEnd/Javascripts/UI/images/ui-webfont.eot?#iefix") format("embedded-opentype"),',
			'url("/api/FrontEnd/Javascripts/UI/images/ui-webfont.woff") format("woff"),',
			'url("/api/FrontEnd/Javascripts/UI/images/ui-webfont.ttf")  format("truetype"),',
			'url("/api/FrontEnd/Javascripts/UI/images/ui-webfont.svg#icon") format("svg");',
			'font-weight: normal;',
			'font-style: normal;',
		'}',
